...
class ScriptError(IntEnum):
    ...
    SCRIPT_ERR_SIG_NONFALCON = 43
    SCRIPT_ERR_MUST_USE_FORKID = 44
    SCRIPT_ERR_DISCOURAGE_UPGRADABLE_NOPS = 45
    SCRIPT_ERR_NONCOMPRESSED_PUBKEY = 46
    SCRIPT_ERR_NUMBER_OVERFLOW = 47
    SCRIPT_ERR_NUMBER_BAD_ENCODING = 48
    SCRIPT_ERR_SIGCHECKS_LIMIT_EXCEEDED = 49

    SCRIPT_ERR_INVALID_NUMBER_RANGE_64_BIT = 50

    SCRIPT_ERR_DATA_REQUIRED = 51
    SCRIPT_ERR_INVALID_TX_INPUT_INDEX = 52
    SCRIPT_ERR_INVALID_TX_OUTPUT_INDEX = 53
