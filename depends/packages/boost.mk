...
$(package)_download_path=https://archives.boost.io/release/$(subset _,.,$($(package)_version))/source/
...
$(package)_config_opts_mingw32=target-os=windows binary-format=pe target-os=windows threadapi=win32 runtime-link=static
...
define $(package)_stage_cmds
  b2 -d0 -j$(JOBS) --prefix=$($(package)_staging_prefix_dir) $($(package)_config_opts) toolset=$($(package)_toolset_$(host_os)) --no-cmake-config install
endef
