...
static void ReportHardwareRand()
{
    ...
    {
        LOGA("Using RdSeed as an additional entropy source\n");
    }
...
static void SeedPeriodic(CSHA512 &hasher, RNGState &rng) noexcept
{
    ...
    LOG(RAND, "Feeding %i bytes of dynamic environment data into RNG\n", hasher.Size() - old_size);
...
static void SeedStartup(CSHA512 &hasher, RNGState &rng) noexcept
{
    ...
    LOG(RAND, "Feeding %i bytes of environment data into RNG\n", hasher.Size() - old_size);
...
{
    uint256 hash;
    ProcRand(hash.begin(), 256 / 8, RNGLevel::FAST);
    return hash;
}
