/* src/config/pyrrha-config.h.  Generated from pyrrha-config.h.in by configure.  */
/* src/config/pyrrha-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef PYRRHA_CONFIG_H

#define PYRRHA_CONFIG_H
