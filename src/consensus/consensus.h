...
#ifndef PYRRHA_CONSENSUS_CONSENSUS_H
#define PYRRHA_CONSENSUS_CONSENSUS_H
...
/** This is the default max bloom filter size allowed on the network.  In Pyrrha we have the ability
...
#endif // PYRRHA_CONSENSUS_CONSENSUS_H
