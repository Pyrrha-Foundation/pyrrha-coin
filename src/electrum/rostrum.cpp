...
{
    std::map<std::string, std::string> portmap = {{"nexa", "3224"}, {"testnet", "13224"}, {"regtest", "23224"}, {"stormtest", "33224"}};
...
{
    std::map<std::string, std::string> portmap = {{"nexa", "20001"}, {"testnet", "30001"}, {"regtest", "30403"}, {"stormtest", "33403"}};
...
{
    const std::map<std::string, std::string> portmap = {{"nexa", "20003"}, {"testnet", "30003"}, {"regtest", "30404"}, {"stormtest", "33404"}};
