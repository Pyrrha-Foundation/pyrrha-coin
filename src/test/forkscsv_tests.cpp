...
{
#if 0 // Pyrrha Version bits removed
    ...
    // dump forks testing
    BOOST_CHECK(NetworkDeploymentInfoCSV(CBaseChainParams::PYRRHA) == std::string(
            "# deployment info for network 'main':\n"
            "main,28,testdummy,1199145601,1230767999,2016,1916,0,0,false\n"));
...
BOOST_AUTO_TEST_CASE(forkscsv_validation_test)
{
    ...
    // network name
    BOOST_CHECK(ValidateNetwork(CBaseChainParams::PYRRHA));
