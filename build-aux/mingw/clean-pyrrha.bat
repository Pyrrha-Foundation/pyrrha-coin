...
%MSYS_SH% "%INST_DIR%\clean-pyrrha.sh"

REM Remove previously built executable outputs that were copied to non-standard location
del /F /Q "%BUILD_OUTPUT%\pyrrha-tx.exe"
del /F /Q "%BUILD_OUTPUT%\pyrrha-cli.exe"
del /F /Q "%BUILD_OUTPUT%\pyrrhad.exe"
del /F /Q "%BUILD_OUTPUT%\pyrrha-miner.exe"
del /F /Q "%BUILD_OUTPUT%\pyrrha-qt.exe"
