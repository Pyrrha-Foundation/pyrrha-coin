Release Notes for Pyrrha 1.2.0
======================================================

Pyrrha version 1.2.0 is now available from:
...
- fix libpyrrha.dylib for osx
- fix rare bug happening during IBD
- various improvements and fixes to libpyrrhakotlin
...
- `a78225a98` Fix macOS M1 build & libpyrrha (Andrey Moiseev)
...
- `93e530fc8` port libpyrrhakotlin header verification native function to cashlib temporarily during the parallel existence (Andrew Stone)
