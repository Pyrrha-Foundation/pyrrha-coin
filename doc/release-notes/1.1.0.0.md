Release Notes for Pyrrha 1.1.0
======================================================

Pyrrha version 1.1.0 is now available from:
...
- `e2f15c2de` Bump pyrrha version to 1.1.0 (Andrea Suisani)
...
- `61a0fc701` Add new testblocks to test_pyrrha.cpp and re-enable some bloom tests. (Peter Tschipper)
...
- `0142af380` Update docker files to work with pyrrha (Andrea Suisani)
...
- `e06d54c8b` Port Bitcoin Core random number seeding to Pyrrha (partial port of Core PR #17265 and following changes).
