Release Notes for Pyrrha 1.3.0.0
======================================================

Pyrrha version 1.3.0.0 is now available from:
...
- `f2359149c` Use pyrrha URL as string to test TestSplitHost() (Andrea Suisani)
- `f8b39bf09` Use pyrrhad default port in unit tests (Andrea Suisani)
- `3d5bce684` Use default pyrrhad port in rpc pyrrha-cli help text (Andrea Suisani)
- `23ae4c1b9` On startup check if the pyrrha.conf file exists and if not then create one (Peter TSchipper)
- `7a7872750` Use default pyrrha main net rpc port in curl help text (Andrea Suisani)
