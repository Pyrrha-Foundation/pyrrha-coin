Release Notes for Pyrrha 1.0.2
======================================================

Pyrrha version 1.0.2 is now available from:
...
- `0fdee74ae` Add a valid PYRRHA mainnet block to the unit tests and use it (Peter Tschipper)
