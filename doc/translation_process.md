...
The Transifex Pyrrha project config file is included as part of the repo. It can be found at `.tx/config`, however you shouldn’t need change anything.
...
To create a new language template, you will need to edit the languages manifest file `src/qt/pyrrha.qrc` and add a new entry. Below is an example of the english language entry.
